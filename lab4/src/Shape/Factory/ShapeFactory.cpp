...
static constexpr auto FAILED_TO_CREATE_SHAPE_NOT_ENOUGH_ARGS_MSG = "Failed to create shape. Not enough arguments in description";
...
ShapeSharedPtr ShapeFactory::CreateShape(const std::string& dscrp) const
{
	...
	if (ss.eof())
	{
		throw std::invalid_argument(FAILED_TO_CREATE_SHAPE_NOT_ENOUGH_ARGS_MSG);
	}
